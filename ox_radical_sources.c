...
/* returns gibbs energy change in J/mol */
{
	...
	switch(rxn) {
		case 2: /* CA* + H <=> CAH  
				    a  + b <=>  c    */
		{
			real ah1 = 3.29950506E+00,  ah2 = 6.30133365E-02,  ah3 = -3.79760083E-05,  ah4 = 1.08180756E-08,  ah5 = -1.18007697E-12;
			real ah6 = 4.47516414E+04,  ah7 = 5.41223132E+00,  al1 = -8.00768796E+00,  al2 = 1.03041289E-01,  al3 = -8.38190998E-05;
			real al4 = 2.76491726E-08,  al5 = -8.88842209E-13,  al6 = 4.70598674E+04,  al7 = 6.07299723E+01,  al8 = 2.10265738E+04;
			real a_tempmid = 1000;
			...
			real bh1 = 0.25000000E+01,  bh2 = 0.00000000E+00,  bh3 = 0.00000000E+00,  bh4 = 0.00000000E+00,  bh5 = 0.00000000E+00;
	 		real bh6 = 0.25473660E+05,  bh7 = -0.44668285E+00,  bl1 = 0.25000000E+01,  bl2 = 0.00000000E+00,  bl3 = 0.00000000E+00;
	 		real bl4 = 0.00000000E+00,  bl5 = 0.00000000E+00,  bl6 = 0.25473660E+05,  bl7 = -0.44668285E+00,  bl8 = 0.26219035E+05;
	 		real b_tempmid = 1000;
			...
			real bS = s_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);
	 		...
	 		real ch1 = 1.76826275E+00,  ch2 = 6.89143506E-02,  ch3 = -4.14322176E-05,  ch4 = 1.17914309E-08, ch5 = -1.28597061E-12;
			real ch6 = 1.45412795E+04,  ch7 = 1.06257927E+01,  cl1 = -8.72434585E+00,  cl2 =  1.05376008E-01,  cl3 = -8.01710690E-05;
			real cl4 = 2.18545974E-08,  cl5 =  1.42066606E-12,  cl6 =  1.66588912E+04,  cl7 = 6.19828860E+01,  cl8 = 2.10522087E+04;
			real c_tempmid = 1000;
				    ...
				    a  + b  <=>  c  + d   */
		{
			...
			real bh1 = 3.66096065E+00,  bh2 = 6.56365811E-04,  bh3 = -1.41149627E-07,  bh4 = 2.05797935E-11,  bh5 =-1.29913436E-15;
			real bh6 = -1.21597718E+03,  bh7 = 3.41536279E+00,  bl1 = 3.78245636E+00,  bl2 = -2.99673416E-03,  bl3 = 9.84730201E-06;
			real bl4 = -9.68129509E-09,  bl5 = 3.24372837E-12,  bl6 = -1.06394356E+03,  bl7 = 3.65767573E+00; 
			real b_tempmid = 1000.0;
			real bH = h_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);
			real bS = s_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);

			real ch1 = 2.10591364E+01,  ch2 = 2.82563070E-02,  ch3 = -1.03328686E-05,  ch4 = 1.68867034E-09,  ch5 = -1.01974767E-13;
			real ch6 = 4.09143507E+03,  ch7 = -8.84963398E+01,  cl1 = -1.15176448E+00,  cl2 = 6.11354512E-02,  cl3 = 3.20151083E-05; 
			real cl4 = -9.94285290E-08,  cl5 = 4.79990043E-11,  cl6 = 1.14058756E+04,  cl7 = 3.25584836E+01,  cl8 = 1.38887800E+04;
			real c_tempmid = 1000.0;
			real cH = h_calc(temp, c_tempmid, ch1, ch2, ch3, ch4, ch5, ch6, ch7, cl1, cl2, cl3, cl4, cl5, cl6, cl7);
			real cS = s_calc(temp, c_tempmid, ch1, ch2, ch3, ch4, ch5, ch6, ch7, cl1, cl2, cl3, cl4, cl5, cl6, cl7);

	 		real dh1 = 2.54363697E+00,  dh2 = -2.73162486E-05,  dh3 = -4.19029520E-09,  dh4 = 4.95481845E-12,  dh5 = -4.79553694E-16;
	 		real dh6 = 2.92260120E+04,  dh7 = 4.92229457E+00,  dl1 = 3.16826710E+00,  dl2 = -3.27931884E-03,  dl3 = 6.64306396E-06;
			real dl4 = -6.12806624E-09,  dl5 = 2.11265971E-12,  dl6 = 2.91222592E+04,  dl7 = 2.05193346E+00,  dl8 = 2.99687009E+04;
		...
		case 5: /* CAH + OH <=> CA* + H2O
				    a  + b  <=>  c  +  d    */
		{
			real ah1 = 1.76826275E+00,  ah2 = 6.89143506E-02,  ah3 = -4.14322176E-05,  ah4 = 1.17914309E-08,  ah5 = -1.28597061E-12;
			real ah6 = 1.45412795E+04,  ah7 = 1.06257927E+01,  al1 = -8.72434585E+00,  al2 =  1.05376008E-01,  al3 = -8.01710690E-05;
			real al4 = 2.18545974E-08,  al5 =  1.42066606E-12,  al6 =  1.66588912E+04,  al7 = 6.19828860E+01,  al8 = 2.10522087E+04;
			real a_tempmid = 1000.0;
			real aH = h_calc(temp, a_tempmid, ah1, ah2, ah3, ah4, ah5, ah6, ah7, al1, al2, al3, al4, al5, al6, al7);
			real aS = s_calc(temp, a_tempmid, ah1, ah2, ah3, ah4, ah5, ah6, ah7, al1, al2, al3, al4, al5, al6, al7);

	 		real bh1 = 2.83853033E+00,  bh2 = 1.10741289E-03,  bh3 = -2.94000209E-07,  bh4 = 4.20698729E-11,  bh5 = -2.42289890E-15;
	 		real bh6 = 3.69780808E+03,  bh7 = 5.84494652E+00,  bl1 = 3.99198424E+00,  bl2 = -2.40106655E-03,  bl3 = 4.61664033E-06;
			real bl4 = -3.87916306E-09,  bl5 = 1.36319502E-12,  bl6 = 3.36889836E+03,  bl7 = -1.03998477E-01,  bl8 = 4.48615380E+03;
			real b_tempmid = 1000.0;
			real bH = h_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);
			real bS = s_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);

			real ch1 = 3.29950506E+00,  ch2 = 6.30133365E-02,  ch3 = -3.79760083E-05,  ch4 = 1.08180756E-08,  ch5 = -1.18007697E-12;
			real ch6 = 4.47516414E+04,  ch7 = 5.41223132E+00,  cl1 = -8.00768796E+00,  cl2 = 1.03041289E-01,  cl3 = -8.38190998E-05;
			real cl4 = 2.76491726E-08,  cl5 = -8.88842209E-13,  cl6 = 4.70598674E+04,  cl7 = 6.07299723E+01,  cl8 = 2.10265738E+04;
			real c_tempmid = 1000.0;
			real cH = h_calc(temp, c_tempmid, ch1, ch2, ch3, ch4, ch5, ch6, ch7, cl1, cl2, cl3, cl4, cl5, cl6, cl7);
			real cS = s_calc(temp, c_tempmid, ch1, ch2, ch3, ch4, ch5, ch6, ch7, cl1, cl2, cl3, cl4, cl5, cl6, cl7);

			real dh1 = 0.26770389E+01,  dh2 = 0.29731816E-02,  dh3 = -0.77376889E-06,  dh4 = 0.94433514E-10,  dh5 = -0.42689991E-14;
			real dh6 = -0.29885894E+05,  dh7 = 0.68825500E+01,  dl1 = 0.41986352E+01,  dl2 = -0.20364017E-02,  dl3 = 0.65203416E-05;
			real dl4 = -0.54879269E-08,  dl5 = 0.17719680E-11,  dl6 = -0.30293726E+05,  dl7 = -0.84900901E+00,  dl8 =-0.29084817E+05;
			real d_tempmid = 1000.0;
			real dH = h_calc(temp, d_tempmid, dh1, dh2, dh3, dh4, dh5, dh6, dh7, dl1, dl2, dl3, dl4, dl5, dl6, dl7);
			real dS = s_calc(temp, d_tempmid, dh1, dh2, dh3, dh4, dh5, dh6, dh7, dl1, dl2, dl3, dl4, dl5, dl6, dl7);
				    ...
				    a  + b <=>  c  + d    */
		{
			...
			real bh1 = 2.54363697E+00,  bh2 = -2.73162486E-05,  bh3 = -4.19029520E-09,  bh4 = 4.95481845E-12,  bh5 = -4.79553694E-16;
	 		real bh6 = 2.92260120E+04,  bh7 = 4.92229457E+00,  bl1 = 3.16826710E+00,  bl2 = -3.27931884E-03,  bl3 = 6.64306396E-06;
			real bl4 = -6.12806624E-09,  bl5 = 2.11265971E-12,  bl6 = 2.91222592E+04,  bl7 = 2.05193346E+00,  bl8 = 2.99687009E+04;
			real b_tempmid = 1000.0;
			real bH = h_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);
			real bS = s_calc(temp, b_tempmid, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl1, bl2, bl3, bl4, bl5, bl6, bl7);
			...
			real dh1 = 2.83853033E+00,  dh2 = 1.10741289E-03,  dh3 = -2.94000209E-07,  dh4 = 4.20698729E-11,  dh5 = -2.42289890E-15;
	 		real dh6 = 3.69780808E+03,  dh7 = 5.84494652E+00,  dl1 = 3.99198424E+00,  dl2 = -2.40106655E-03,  dl3 = 4.61664033E-06;
			real dl4 = -3.87916306E-09,  dl5 = 1.36319502E-12,  dl6 = 3.36889836E+03,  dl7 = -1.03998477E-01,  dl8 = 4.48615380E+03;
			real d_tempmid = 1000.0;
			real dH = h_calc(temp, d_tempmid, dh1, dh2, dh3, dh4, dh5, dh6, dh7, dl1, dl2, dl3, dl4, dl5, dl6, dl7);
			real dS = s_calc(temp, d_tempmid, dh1, dh2, dh3, dh4, dh5, dh6, dh7, dl1, dl2, dl3, dl4, dl5, dl6, dl7);
