...
real CoagDiffM0(real m0,real m1,real m2,real Kf)
{
    ...
    572*pow(m0,2.0/9)*pow(m1,6)*pow(m2,2.0/9) + 254*pow(m0,2)*pow(m1,22.0/9)*pow(m2,2) + \
    536*pow(m0,11.0/9)*pow(m1,4)*pow(m2,11.0/9) + 157*pow(m0,14.0/9)*pow(m1,4)*pow(m2,8.0/9) + \
    ...
    314*pow(m0,28.0/9)*pow(m1,8.0/9)*pow(m2,22.0/9))) /(72*pow(m1,17.0/18)*pow(pow(m0,7.0/4)*pow(m2,3.0/4) + \
    pow(m0,23.0/36)*pow(m1,14.0/9)*pow(m2,11.0/36),(5.0/8))*pow(pow(m1,4.0/3) + pow(m0,2.0/3)*pow(m2,2.0/3) + \
    2*pow(m0,2.0/9)*pow(m1,8.0/9)*pow(m2,2.0/9),(1.0/4))*pow(2*pow(m1,32.0/9) + pow(m0,16.0/9)*pow(m2,16.0/9) + \ 
...
real CoagDiffM2(real m0,real m1,real m2,real Kf)
{
    ...
    167*pow(m0,38.0/9)*pow(m1,14.0/3)*pow(m2,20.0/9) + 41*pow(m0,37.0/18)*pow(m1,8)*pow(m2,19.0/18) + \
    ...
    50*pow(m0,59.0/18)*pow(m1,50.0/9)*pow(m2,41.0/18))) / (144*pow(m0,1.0/18)*pow(m1,25.0/36)*pow(m2,8.0/9)*pow(2*pow(m1,20.0/9) + \
    pow(m0,29.0/18)*pow(m2,11.0/18),(5.0/8))*pow(pow(m1,10.0/3) + pow(m0,13.0/6)*pow(m2,7.0/6) + \
    2*pow(m0,2.0/9)*pow(m1,26.0/9)*pow(m2,2.0/9),(1.0/4))*pow(2*pow(m1,50.0/9) + pow(m0,59.0/18)*pow(m2,41.0/18) \
